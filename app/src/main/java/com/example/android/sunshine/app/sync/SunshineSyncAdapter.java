...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private static final String TAG = SunshineSyncAdapter.class.getName();
    ...
    private double mTempHigh = 1;
    private double mTempLow = 1;
    ...
    private void updateWatchFace() {
        Log.d(TAG, "updateWatchFace " + mTempLow + " - " + mTempHigh);

        PutDataMapRequest putDataMapRequest = PutDataMapRequest.create(PATH);
        DataMap dataMap = putDataMapRequest.getDataMap();
        dataMap.putInt(KEY_WEATHER_ID, mWeatherId);
        dataMap.putDouble(KEY_LOW_TEMP, mTempLow);
        dataMap.putDouble(KEY_HIGH_TEMP, mTempHigh);
        new WatchFaceUpdater(getContext(), putDataMapRequest);
    }
    ...
    class WatchFaceUpdater implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
        private final String TAG = WatchFaceUpdater.class.getSimpleName();
        private GoogleApiClient mGoogleApiClient;
        private PutDataMapRequest mPutDataMapRequest;

        public WatchFaceUpdater(Context context, PutDataMapRequest putDataMapRequest) {
        ...
        public void onConnectionSuspended(int cause) {
            Log.e(TAG, "onConnectionSuspended: " + Integer.toString(cause));
        }
